...
mpif90 -c ${LANG_OPTS} ${WARN_OPTS} ${MACH_OPTS} -Ifortranlib compareMasks.F90
...
mpif90 -o compareMasks ${LANG_OPTS} ${WARN_OPTS} ${MACH_OPTS} compareMasks.o fortranlib/*.o -Lfortranlib
