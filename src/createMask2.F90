PROGRAM main
    ...
    CALL EXECUTE_COMMAND_LINE("mkdir -p ../createMask2output", CMDMSG = errmsg, EXITSTAT = errnum)
    ...
    DO i = 1_INT64, nmax
        ...
        ! Create file names ...
        WRITE(bname, '("../createMask2output/mask", i4.4, ".bin")') i
        WRITE(iname, '("../createMask2output/mask", i4.4, ".ppm")') i
